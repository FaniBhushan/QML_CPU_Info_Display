...
#include "../CPUInfoDisplayUsingQObject/stringlistmodel.h"
...
QT_MOC_LITERAL(3, 30, 9), // "listModel"
QT_MOC_LITERAL(4, 40, 19) // "QAbstractItemModel*"

    },
    "StringListModel\0modelChanged\0\0listModel\0"
    "QAbstractItemModel*"
};
...
void StringListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (StringListModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&StringListModel::modelChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QAbstractItemModel**>(_v) = _t->getListModel(); break;
        default: break;
        }
...
const QMetaObject StringListModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_StringListModel.data,
...
// SIGNAL 0
void StringListModel::modelChanged()
{
